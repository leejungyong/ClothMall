export default {
  ...
  'menu.productmanage.editgoods':'编辑产品',
  'menu.productmanage.newproduct':'新增产品',
  'menu.productmanage.list':'产品列表',
  'menu.productmanage.colormanage':'颜色管理',
  'menu.productmanage.hotgoods':'热门商品展示配置',
  'menu.shopinfo':'店铺基本资料',
