...
import findRoute, {
  getUrlQuery,
} from '/Users/xuehuiwan/Documents/1031/ClothMall/frontend/web/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/xuehuiwan/Documents/1031/ClothMall/frontend/web',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
